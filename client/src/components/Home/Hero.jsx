  ...
  return (
    <div className=" flex flex-row w-screen items-center overflow-hidden px-4">
      <div className="w-1/2 ">
        ...
        <button className="bg-[#003cd8] text-white xl:py-4 xl:px-10 px-2 py-1 hover:shadow-2xl hover:shadow-[#003cd8] rounded-xl transition-all active:translate-y-3 font-bold ">
          Get Started
        </button>
      </div>
      <div className="w-1/2 ">
