...
const NewsLetter = () => {
  return (
    <div className="flex items-center  justify-center">
      <div className="absolute bottom-[40px] flex flex-row items-center justify-center mx-2 px-4 border-2 hover:border-[#003CD8] rounded-xl py-4 bg-white md:gap-10 hover:shadow-xl transition-all transition-200 md:p-8 lg:px-20 lg:gap-28 lg:justify-between xl:gap-96">
